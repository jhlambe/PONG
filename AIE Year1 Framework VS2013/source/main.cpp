...
THE CONSENT PROFANITY IS AN ISSUE AS WELL. THIS STARTED DAY ONE AND I TRYED TO OFFER YOU A SOLUTION THAT WOULD WORK FOR ME BUT IT WASN'T NOTED.
THIS MIGHT BE HOW IT WORKS IN THE "REAL WORLD" BUT THIS IS A CLASS ROOM AND 
THE CURRENT ENVIROMENT DOES NOT PROVIDE A CODUCIVE LEARNING ENVIROMENT.
...
Pass by reference rather than a pointer this is sweet and clean. (ball& b)  in the function Parameter THIS IS CLEVER BUT I NEED TO UNDERSTAND BETTER.
make everthing in functions cuz we can't use classes.

TO DO LIST
WRITE SCORING TO SCREEN 
RESEARCH ITOA (THX TO JEFFREY JOHNSON)
STUDY FILE I/O FOR HIGHSCORE
*/
